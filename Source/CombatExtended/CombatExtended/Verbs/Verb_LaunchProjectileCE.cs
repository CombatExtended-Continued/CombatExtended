...
namespace CombatExtended
{
    public class Verb_LaunchProjectileCE : Verse.Verb
    {
        ...
        protected float ShootingAccuracy => Mathf.Min(Shooter.GetStatValue(StatDefOf.ShootingAccuracy), 4.5f);
        protected float AimingAccuracy => Mathf.Min(Shooter.GetStatValue(CE_StatDefOf.AimingAccuracy), 1.5f);
