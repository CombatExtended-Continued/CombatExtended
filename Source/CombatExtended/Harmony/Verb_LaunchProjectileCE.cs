...
namespace CombatExtended.Harmony
{
    ...
    internal static class Harmony_Verb_LaunchProjectileCE
    {
        internal static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
        {
            ...
            {
                Log.Error($"Combat Extended FastTrack Edition :: Transpiler could not find method info for {typeof(Verb_LaunchProjectileCE).Name}.{nameof(Verb_LaunchProjectileCE.TryStartCastOn)}");
            }
