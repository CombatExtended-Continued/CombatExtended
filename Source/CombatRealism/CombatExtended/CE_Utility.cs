...
namespace CombatExtended
{
    static class CE_Utility
    {
        ...
        {
            Log.Message("CE :: called GetAfterArmorDamage with " + dinfo.ToString() + ", BodyPartGroup null " + (dinfo.WeaponBodyPartGroup == null).ToString());
            String hediffString = null;
            if (dinfo.WeaponLinkedHediff != null)
            {
                hediffString = dinfo.WeaponLinkedHediff.ToString();
            }
            Log.Message("CE :: dinfo WeaponLinkedHediff " + hediffString);
            ...
            if(dinfo.WeaponGear != null)
            {
                ...
                if(instigatorPawn != null)
                {
                    ...
                    if (instigatorPawn.def == dinfo.WeaponGear)
                    {
                        ...
                        {
                            return instigatorPawn.GetStatValue(CE_StatDefOf.ArmorPenetration);
                        }
                    }
                }
            }
